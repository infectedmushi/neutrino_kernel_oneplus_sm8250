#!/bin/bash
KERNEL_DIR="/mnt/Building/neutrino_kernel_oneplus_sm8250"
...
cd ${KERNEL_DIR}
make O=${PRODUCT_OUT} clean
make O=${PRODUCT_OUT} mrproper
#rm -rf out
make O=${PRODUCT_OUT} CC=clang neutrino_llvm_defconfig
make O=${PRODUCT_OUT} -j$(nproc --all) CC=clang CROSS_COMPILE=/mnt/Building/gcc-linaro-12.0.0-2021.11-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu- CROSS_COMPILE_COMPAT=/mnt/Building/gcc-arm-10.3-2021.07-x86_64-arm-none-eabi/bin/arm-none-eabi-
